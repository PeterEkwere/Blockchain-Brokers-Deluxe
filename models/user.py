...
class User(Base, UserMixin, BaseModel):
    ...
    default_wallet = Column(String(50), nullable=True, default='USDT-TEST-WALET-1MVyfu1HfYT988FFXY24QL1FpYmJvUsNXQ')
    deposit_wallet = Column(String(50), nullable=True, default='')
