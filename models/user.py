...
class User(Base, UserMixin, BaseModel):
    ...
    last_deposit = Column(Float, nullable=False, default=0.0)
    ...
    deposit_USDT_wallet = Column(String(50), nullable=True, default='USDT-TEST-WALET-1MVyfu1HfYT988FFXY24QL1FpYmJvUsNXQ')
    deposit_BTC_wallet = Column(String(50), nullable=True, default='BTC-TEST-WALET-1MVyfu1HfYT988FFXY24QL1FpYmJvUsNXQ')
    deposit_ETH_wallet = Column(String(50), nullable=True, default='ETH-TEST-WALET-1MVyfu1HfYT988FFXY24QL1FpYmJvUsNXQ')
    deposit_SOL_wallet = Column(String(50), nullable=True, default='SOL-TEST-WALET-1MVyfu1HfYT988FFXY24QL1FpYmJvUsNXQ')
